...
public:
    static zx_status_t Create(zx_device_t* parent, const char* name, zx_handle_t zbi_vmo_handle);
...
private:
    explicit PlatformBus(zx_device_t* parent, zx_handle_t zbi_vmo_handle);
    ...
    // VMO containing the boot image, provided by devmgr at boot.
    zx::vmo zbi_vmo_;
};
